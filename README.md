# React Basic Form - React/Redux

This application will allow you to input form fields like Textbox, Radio and Dropdown with basic validation. Also, it will maintain state of all fields and will show as a JSON object on the bottom of the page.
## Installation & Usage
